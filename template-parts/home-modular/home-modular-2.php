...
$post_num = $id['modular7_post_num'] ?: '6';
...
<section class="service-section4 pb-40 modular_display_<?php echo $id['modular_display'];?> <?php if( $id['modular_bg_f9'] ){ echo 'bg-f9'; }?>">
<div class="container">
   ...
   ?>
    ...
    <div class="row tab-category-menu">
      <div class="col-md-12">
        ...
        <a href="javascript:;" <?php if( $i == '1' ){ echo 'class="two_sels"'; }?> id="b<?php echo $md5;?><?php echo $i;?>" onMouseOver="a<?php echo $md5;?><?php echo $count_cat;?>('b<?php echo $md5;?>', 'c<?php echo $md5;?>', <?php echo $i;?>, <?php echo $count_cat;?>,'two_sels')"><?php echo get_cat_name( $catid );?></a>
        <?php $i++; } }?>
      </div>
    </div>
    <?php }?>
    ...
    <div class="row tab-category-posts<?php if( $s != '1' ){ echo ' divhidden'; }?>" id="c<?php echo $md5;?><?php echo $s;?>">
      ...
      ?>
      <div class="module-cat-more">
				<a href="<?php echo get_category_link( $catid ); ?>" target="_blank">More</a>
			</div>
    </div>
    <?php $s++; } }
