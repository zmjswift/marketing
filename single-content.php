                ...
                <div class="col-lg-8">
                    <div class="product-text">
                        ...
                        <ul class="product_meta">
                            ...
                            <?php } ?>
                            <li><i class="fa fa-qrcode" data-article-url="<?php echo esc_url(get_the_permalink()); ?>"
...
"></i></li>
    ...
    foreach ($options as $option) : ?>
                        ...
                        <?php if ($branding) { ?>
                        <div class="branding">
                            <img src="<?php echo $branding; ?>" style="max-width: 80%;">
                        </div>
                        <?php } ?>
                    </div>
                </div>
...
get_sidebar();
            ...
            get_breadcrumbs();
                ...
                <ul class="nav nav-pills">
                    <li class="item">
                        <a data-toggle1="tab" href="#tab1" aria-expanded="true" data-to="tab1" class="tab1 active show">
                            Product Details
                        </a>
                    </li>
                    <?php if (dq('tab-title-1')) { ?>
                    <li class="item">
                        <a data-toggle1="tab" href="#tab2" aria-expanded="false" data-to="tab2" class="tab2">
                    ...
                    <li class="item">
                        <a data-toggle1="tab" href="#tab3" aria-expanded="false" data-to="tab3" class="tab3">
                    ...
                    <li class="item">
                        <a data-toggle1="tab" href="#tab4" aria-expanded="false" data-to="tab4" class="tab4">
            ...
            the_content();
                        ...
                        <div class="share-links-wrap">
                            <p><?php esc_html_e('Share: ', 'dq_theme'); ?></p>
                            <ul class="share-links hoverable">
                                <?php
                            ...
                            <a href="<?php echo get_permalink($prev_post->ID); ?>" target="_blank" class="post-prev">
                                <div class="thumb">
                                    <img loading="lazy" alt="<?php echo $prev_post->post_title; ?>"
                                        src="<?php echo dqtheme_prev_thumbnail_url(); ?>">
                                </div>
                            ...
                            <a href="<?php echo get_permalink($next_post->ID); ?>" target="_blank" class="post-next">
                                <div class="thumb">
                                    <img loading="lazy" alt="<?php echo $next_post->post_title; ?>"
                                        src="<?php echo dqtheme_next_thumbnail_url(); ?>">
                                </div>
                                <div class="post-title">
                                    <p>Next:</p>
