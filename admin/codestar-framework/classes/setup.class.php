...
if( ! class_exists( 'CSF' ) ) {
  class CSF {
    ...
    public static function add_admin_enqueue_scripts() {
      ...
      $min = ( apply_filters( 'csf_dev_mode', false ) || WP_DEBUG ) ? '.min' : '.min';
      ...
      wp_enqueue_style( 'csf-fa', get_template_directory_uri().'/static/font-awesome/css/font-awesome.min.css', array(), '4.7.1', 'all' );

      // framework core styles
      wp_enqueue_style( 'csf', CSF::include_plugin_url( 'assets/css/csf'. $min .'.css' ), array(), '1.0.0', 'all' );
      //wp_enqueue_style( 'iconfont', get_bloginfo('template_directory') .'/static/font/iconfont.css', array(), 'dqtheme', 'all' );
      //wp_enqueue_style( 'line-awesome', get_bloginfo('template_directory') .'/static/line-awesome/css/line-awesome.min.css', array(), 'dqtheme', 'all' );
      ...
      wp_localize_script( 'csf', 'csf_vars', array(
        ...
        'i18n'           => array(
          ...
          // chosen localize
          'typing_text'     => esc_html__( '请输入 %s 个或更多字符进行搜索', 'csf' ),
          'searching_text'  => esc_html__( '搜索中...', 'csf' ),
          'no_results_text' => esc_html__( '没有匹配的结果', 'csf' ),
        ),
      ) );
