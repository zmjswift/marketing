  ...
  class CSF_Field_repeater extends CSF_Fields {
    ...
    public function render() {
      ...
      if( $this->parent && preg_match( '/'. preg_quote( '['. $this->field['id'] .']' ) .'/', $this->parent ) ) {
        ...
        echo '<div class="csf-repeater-alert csf-repeater-max">'. esc_html__( '不能添加超过', 'csf' ) .' '. $args['max'] .'</div>';
        echo '<div class="csf-repeater-alert csf-repeater-min">'. esc_html__( '不能删除小于', 'csf' ) .' '. $args['min'] .'</div>';
