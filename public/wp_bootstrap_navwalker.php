...
if ( ! class_exists( 'WP_Bootstrap_Navwalker' ) ) :
    ...
    class WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
        ...
        public static function fallback( $args ) {
            ...
            $fallback_output .= '<li class="nav-item"><a href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '" class="nav-link" title="' . esc_attr__( '请前往「后台-外观-菜单」中添加菜单，注意勾选菜单显示位置（此处为主菜单）', 'wp-bootstrap-navwalker' ) . '">' . esc_html__( '请前往「后台-外观-菜单」中添加菜单，注意勾选菜单显示位置（此处为主菜单）', 'wp-bootstrap-navwalker' ) . '</a></li>';
            $fallback_output .= '</ul>';
