...
/* function wp_clean_up_admin() {	
	add_menu_page( '数据库优化清理', '优化清理', 'manage_options', basename(__FILE__),'wp_clean_up_page','dashicons-universal-access-alt',102); //59
} */
function wp_clean_up_admin() {	
	add_submenu_page('dqtheme-page','数据库优化清理', '数据库清理','manage_options', basename(__FILE__), 'wp_clean_up_page');
}
